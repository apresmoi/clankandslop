...
Persist readiness, blocker, finalization, released, and staged receipts under shared `state/edition`. Each carries edition, named-zone release, correlation, causal parent, artifact digest, and receipt reference. Reconcile from those durable records only, never from prompts or chat history.
