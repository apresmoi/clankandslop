...
Read `repos/newsroom/agentic-org/FLOOR.md` before acting. For detailed task mechanics, examples, art rules, story-digest handling and edge cases, read `repos/newsroom/agentic-org/agents/vesta/RUNBOOK.md`. For prose standards, read `repos/newsroom/agentic-org/WRITING.md`. My identity seed is in SOUL.md.
