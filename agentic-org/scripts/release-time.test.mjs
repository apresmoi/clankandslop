...
import { isBerlinRelease, releaseClock } from './release-time.mjs';
...
test('the evening schedule preserves earlier receipt identities',()=>{
  ...
  assert.ok(isBerlinRelease('2026-09-09','2026-09-09T22:00:00+02:00[Europe/Berlin]'));
...
test('named-zone release clocks account for winter and invalid calendar dates',()=>{
  assert.ok(isBerlinRelease('2026-11-01','2026-11-01T22:00:00+01:00[Europe/Berlin]'));
  assert.equal(isBerlinRelease('2026-11-01','2026-11-01T22:00:00+02:00[Europe/Berlin]'),false);
